...
const day11 = makeDay({
  ...
  prompts: [
    prompt("sp11-p1", "What's an app you use every day?", "¿Qué app usas todos los días?", "I use…", "Uso…", "WHAT"),
    prompt("sp11-p2", "Why do you use it?", "¿Por qué la usas?", "I use it because…", "La uso porque…", "WHY"),
...
const day15 = makeDay({
  ...
  prompts: [
    prompt("sp15-p1", "What process do you want to explain?", "¿Qué proceso quieres explicar?", "I want to explain…", "Quiero explicar…", "WHAT"),
    prompt("sp15-p2", "Why is this process useful for you?", "¿Por qué es útil este proceso para ti?", "It is useful because…", "Es útil porque…", "WHY"),
...
const day16 = makeDay({
  ...
  prompts: [
    ...
    prompt("sp16-p3", "Who is walking her dog?", "¿Quién está paseando a su perro?", "A woman is…", "Una mujer está…", "WHO"),
    prompt("sp16-p2", "What are the two children playing?", "¿Qué están jugando los dos niños?", "They are playing…", "Ellos están jugando…", "WHAT"),
...
const day17 = makeDay({
  ...
  prompts: [
    prompt("sp17-p1", "Who is swimming in the ocean?", "¿Quién está nadando en el mar?", "Two people are…", "Dos personas están…", "WHO"),
    prompt("sp17-p2", "What is the child doing?", "¿Qué está haciendo el niño?", "He is…", "Él está…", "WHAT"),
    prompt("sp17-p3", "Where is the couple walking?", "¿Dónde está caminando la pareja?", "They are walking…", "Ellos están caminando…", "WHERE"),
...
const day18 = makeDay({
  ...
  prompts: [
    ...
    prompt("sp18-p2", "Who is typing on the computer?", "¿Quién está escribiendo en la computadora?", "A man is…", "Un hombre está…", "WHO"),
    prompt("sp18-p4", "What are the two people doing together?", "¿Qué están haciendo juntas las dos personas?", "They are having…", "Ellos están teniendo…", "WHAT"),
...
const day19 = makeDay({
  ...
  prompts: [
    ...
    prompt("sp19-p2", "Who is cleaning the floor?", "¿Quién está limpiando el piso?", "A man is…", "Un hombre está…", "WHO"),
    prompt("sp19-p3", "Where is the cat sleeping?", "¿Dónde está durmiendo el gato?", "The cat is sleeping…", "El gato está durmiendo…", "WHERE"),
...
const day20 = makeDay({
  ...
  prompts: [
    ...
    prompt("sp20-p2", "Who is checking her phone?", "¿Quién está revisando su teléfono?", "A woman is…", "Una mujer está…", "WHO"),
    prompt("sp20-p3", "What is happening near the desk?", "¿Qué está pasando cerca del mostrador?", "A woman is talking to…", "Una mujer está hablando con…", "WHAT"),
