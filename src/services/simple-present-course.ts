...
const day6 = makeDay({
  ...
  prompts: [
    prompt("sp6-p1", "What time does he / she wake up?", "¿A qué hora se levanta él / ella?", "He / She wakes up…", "Él / Ella se levanta…"),
    prompt("sp6-p2", "What does he / she do in the morning?", "¿Qué hace él / ella en la mañana?", "He / She has…", "Él / Ella toma…"),
    prompt("sp6-p3", "What does he / she do during the day?", "¿Qué hace él / ella durante el día?", "He / She usually…", "Él / Ella normalmente…"),
    prompt("sp6-p4", "Does he / she work every day?", "¿Trabaja él / ella todos los días?", "Yes, he / she works… / No, he / she doesn't…", "Sí, trabaja… / No, no trabaja…"),
    prompt("sp6-p5", "What doesn't he / she do?", "¿Qué no hace él / ella?", "He / She doesn't…", "Él / Ella no…"),
    prompt("sp6-p6", "Why does he / she like the routine?", "¿Por qué le gusta la rutina?", "He / She likes it because…", "Le gusta porque…"),
  ],
...
const day7 = makeDay({
  ...
  prompts: [
    prompt("sp7-p1", "What time does the athlete wake up?", "¿A qué hora se levanta el atleta?", "He wakes up…", "Él se levanta…"),
    prompt("sp7-p2", "What does he eat?", "¿Qué come?", "He eats…", "Él come…"),
    prompt("sp7-p3", "How often does he train?", "¿Con qué frecuencia entrena?", "He trains…", "Él entrena…"),
    prompt("sp7-p4", "What does he do with his family?", "¿Qué hace con su familia?", "He spends…", "Él pasa…"),
    prompt("sp7-p5", "What doesn't he do?", "¿Qué no hace?", "He doesn't…", "Él no…"),
    prompt("sp7-p6", "Why does he take care of his body?", "¿Por qué cuida su cuerpo?", "He takes care of his body because…", "Cuida su cuerpo porque…"),
  ],
...
const day8 = makeDay({
  ...
  prompts: [
    prompt("sp8-p1", "Who is your superhero?", "¿Quién es tu superhéroe?", "My superhero is…", "Mi superhéroe es…"),
    prompt("sp8-p2", "What does he / she do for work?", "¿En qué trabaja?", "He / She works as…", "Él / Ella trabaja como…"),
    prompt("sp8-p3", "What does he / she do every day?", "¿Qué hace todos los días?", "He / She helps…", "Él / Ella ayuda…"),
    prompt("sp8-p4", "What special thing does he / she do?", "¿Qué cosa especial hace?", "He / She flies / runs / saves…", "Él / Ella vuela / corre / salva…"),
    prompt("sp8-p5", "What doesn't he / she do?", "¿Qué no hace?", "He / She doesn't…", "Él / Ella no…"),
    prompt("sp8-p6", "Why does he / she help people?", "¿Por qué ayuda a la gente?", "He / She helps people because…", "Ayuda a la gente porque…"),
  ],
...
const day9 = makeDay({
  ...
  prompts: [
    prompt("sp9-p1", "Who is the performer?", "¿Quién es el / la artista?", "The singer is…", "El / La cantante es…"),
    prompt("sp9-p2", "How does he / she start the day?", "¿Cómo empieza el día?", "He / She usually starts…", "Él / Ella normalmente empieza…"),
    prompt("sp9-p3", "What does he / she practice?", "¿Qué practica?", "He / She practices…", "Él / Ella practica…"),
    prompt("sp9-p4", "What does he / she sometimes do?", "¿Qué hace a veces?", "He / She sometimes…", "Él / Ella a veces…"),
    prompt("sp9-p5", "What doesn't he / she have?", "¿Qué no tiene?", "He / She doesn't have…", "Él / Ella no tiene…"),
    prompt("sp9-p6", "Why does he / she practice a lot?", "¿Por qué practica mucho?", "He / She practices a lot because…", "Practica mucho porque…"),
  ],
...
const day10 = makeDay({
  ...
  prompts: [
    prompt("sp10-p1", "What does he / she do every day?", "¿Qué hace él / ella todos los días?", "He / She…", "Él / Ella…"),
    prompt("sp10-p2", "What does he / she usually do?", "¿Qué hace normalmente?", "He / She usually…", "Él / Ella normalmente…"),
    prompt("sp10-p3", "What doesn't he / she do?", "¿Qué no hace?", "He / She doesn't…", "Él / Ella no…"),
    prompt("sp10-p4", "Ask ONE question about this person.", "Haz UNA pregunta sobre esta persona.", "What does…? / Does he / she…? / What time does…?", "What does…? / Does he / she…? / What time does…?"),
  ],
...
const day11 = makeDay({
  ...
  prompts: [
    prompt("sp11-p1", "What do you do first?", "¿Qué haces primero?", "First, I open…", "Primero, abro…"),
    prompt("sp11-p2", "What do you search for?", "¿Qué buscas?", "Then, I search for…", "Luego, busco…"),
    prompt("sp11-p3", "What do you select and check?", "¿Qué seleccionas y revisas?", "Next, I select… I check…", "Después, selecciono… Reviso…"),
    prompt("sp11-p4", "What happens after that?", "¿Qué pasa después de eso?", "After that, I tap…", "Después de eso, toco…"),
    prompt("sp11-p5", "What do you do while you wait?", "¿Qué haces mientras esperas?", "I wait for…", "Espero a que…"),
    prompt("sp11-p6", "What do you do at the end?", "¿Qué haces al final?", "Finally,…", "Finalmente,…"),
  ],
...
const day12 = makeDay({
  ...
  prompts: [
    prompt("sp12-p1", "What do you do first?", "¿Qué haces primero?", "First, I prepare…", "Primero, preparo…"),
    prompt("sp12-p2", "What do you put on the tray?", "¿Qué pones en la bandeja?", "Then, I put…", "Luego, pongo…"),
    prompt("sp12-p3", "What do you add?", "¿Qué agregas?", "Next, I add…", "Después, agrego…"),
    prompt("sp12-p4", "What are your favorite toppings?", "¿Cuáles son tus ingredientes favoritos?", "After that, I add…", "Después de eso, agrego…"),
    prompt("sp12-p5", "What happens in the oven?", "¿Qué pasa en el horno?", "Then, I put… I wait…", "Luego, meto… Espero…"),
    prompt("sp12-p6", "What do you do at the end?", "¿Qué haces al final?", "Finally,…", "Finalmente,…"),
  ],
...
const day13 = makeDay({
  ...
  prompts: [
    prompt("sp13-p1", "What do you do first?", "¿Qué haces primero?", "First, I open…", "Primero, abro…"),
    prompt("sp13-p2", "How do you choose a restaurant?", "¿Cómo eliges un restaurante?", "Then, I choose…", "Luego, elijo…"),
    prompt("sp13-p3", "What do you look at?", "¿Qué ves?", "Next, I look at…", "Después, veo…"),
    prompt("sp13-p4", "What do you order?", "¿Qué pides?", "I select…", "Selecciono…"),
    prompt("sp13-p5", "What do you check before you pay?", "¿Qué revisas antes de pagar?", "Then, I check…", "Luego, reviso…"),
    prompt("sp13-p6", "What happens at the end?", "¿Qué pasa al final?", "Finally,…", "Finalmente,…"),
  ],
...
const day14 = makeDay({
  ...
  prompts: [
    prompt("sp14-p1", "What do you do first?", "¿Qué haces primero?", "First, I get…", "Primero, tomo…"),
    prompt("sp14-p2", "What do you add?", "¿Qué agregas?", "Then, I add…", "Luego, agrego…"),
    prompt("sp14-p3", "What vegetables do you like?", "¿Qué vegetales te gustan?", "Next, I add…", "Después, agrego…"),
    prompt("sp14-p4", "What other ingredient do you use?", "¿Qué otro ingrediente usas?", "I add…", "Agrego…"),
    prompt("sp14-p5", "How do you cut it?", "¿Cómo lo cortas?", "Then, I cut…", "Luego, corto…"),
    prompt("sp14-p6", "What do you do at the end?", "¿Qué haces al final?", "Finally,…", "Finalmente,…"),
  ],
