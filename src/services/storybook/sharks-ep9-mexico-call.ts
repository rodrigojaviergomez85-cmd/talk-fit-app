  ...
  "scenes": [
    {
      "id": "s1",
      "image": s1,
      "imageAlt": "Scene 1 of The Mexico call.",
    ...
    },
    {
      "id": "s2",
      "image": s2,
      "imageAlt": "Scene 2 of The Mexico call.",
    ...
    },
    {
      "id": "s3",
      "image": s3,
      "imageAlt": "Scene 3 of The Mexico call.",
    ...
    },
    {
      "id": "s4",
      "image": s4,
      "imageAlt": "Scene 4 of The Mexico call.",
    ...
    },
    {
      "id": "s5",
      "image": s5,
      "imageAlt": "Scene 5 of The Mexico call.",
    ...
    },
    {
      "id": "s6",
      "image": s6,
      "imageAlt": "Scene 6 of The Mexico call.",
    ...
    },
    {
      "id": "s7",
      "image": s7,
      "imageAlt": "Scene 7 of The Mexico call.",
    ...
    },
    {
      "id": "s8",
      "image": s8,
      "imageAlt": "Scene 8 of The Mexico call.",
    ...
    },
    {
      "id": "s9",
      "image": s9,
      "imageAlt": "Scene 9 of The Mexico call.",
    ...
    },
    {
      "id": "s10",
      "image": s10,
      "imageAlt": "Scene 10 of The Mexico call.",
    ...
    },
    {
      "id": "s11",
      "image": s11,
      "imageAlt": "Scene 11 of The Mexico call.",
  ...
  "quizzes": [
    {
      ...
      "options": [
        {
          "label": "Please do, because I do not buy franchises. I build schools.",
          "emoji": "🎯"
        },
        {
    ...
    },
    {
      ...
      "options": [
        {
          "label": "Let me clear that up. The license is annual, and support is based on active students.",
          "emoji": "💬"
        },
        {
    ...
    },
    {
      ...
      "options": [
        {
          "label": "Good. You should also know that I own six schools that compete with you.",
          "emoji": "⚡"
        },
        {
      ...
      "answer": 0,
      "sayIt": "Good. You should also know that I own six schools that compete with you.",
