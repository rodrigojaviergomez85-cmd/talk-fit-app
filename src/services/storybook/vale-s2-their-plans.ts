...
import cover from "@/assets/storybook/vale-s2-ep10/cover.jpg";
import s1 from "@/assets/storybook/vale-s2-ep10/s1.jpg";
import s2 from "@/assets/storybook/vale-s2-ep10/s2.jpg";
import s3 from "@/assets/storybook/vale-s2-ep10/s3.jpg";
import s4 from "@/assets/storybook/vale-s2-ep10/s4.jpg";
import s5 from "@/assets/storybook/vale-s2-ep10/s5.jpg";
import s6 from "@/assets/storybook/vale-s2-ep10/s6.jpg";
import s7 from "@/assets/storybook/vale-s2-ep10/s7.jpg";
import s8 from "@/assets/storybook/vale-s2-ep10/s8.jpg";
import s9 from "@/assets/storybook/vale-s2-ep10/s9.jpg";
import s10 from "@/assets/storybook/vale-s2-ep10/s10.jpg";
...
export const VALE_S2_THEIR_PLANS: StorybookEpisode = {
  ...
  quizzes: [
    ...
    },
    {
      ...
      answer: 0,
      sayIt: "He is going to start a new job.",
      sayItEs: "Ejemplo: «He is going to start a new job.»",
      sayItAskEn: "What is your friend going to do this year?",
      sayItAskEs: "¿Qué va a hacer tu amigo este año?",
      sayItCheck: {
        target: "He is going to *",
        altTargets: ["She is going to *"],
      },
    },
    {
      id: "q3",
      ...
      answer: 0,
      sayIt: "I’m going to start on Monday.",
      sayItEs: "Ejemplo: «I’m going to start on Monday.»",
      sayItAskEn: "When are you going to start practicing more?",
      sayItAskEs: "¿Cuándo vas a empezar a practicar más?",
      sayItCheck: {
        target: "I’m going to start *",
      },
    },
  ],
  mindsetCard: {
