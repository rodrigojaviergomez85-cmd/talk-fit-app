...
export const VALE_WE_ARE_A_TEAM: StorybookEpisode = {
  ...
  scenes: [
    ...
    { id: "s9", image: s9, imageAlt: "Ana aplaude orgullosa al equipo.", text: '"Good job, team. You are amazing," says Ana.', es: "«Buen trabajo, equipo. Son increíbles», dice Ana.", speaker: "ana", words: [{ word: "job", es: "trabajo" }, { word: "amazing", es: "increíbles" }] },
  ...
  quizzes: [
    { id: "q1", afterScene: "s2", questionEn: "How is Vale today?", questionEs: "¿Cómo está Vale hoy?", options: [{ label: "Ready", emoji: "💪" }, { label: "Scared", emoji: "😨" }, { label: "Sleepy", emoji: "😴" }], answer: 0, sayIt: "I am ready.", sayItEs: "Repite: «Estoy lista.»", sayItCheck: { target: "I am ready." } },
    { id: "q2", afterScene: "s6", questionEn: "Who finds the answer?", questionEs: "¿Quién encuentra la respuesta?", options: [{ label: "Mateo", emoji: "👦" }, { label: "Ana", emoji: "👩‍💼" }, { label: "Dylan", emoji: "🧑" }], answer: 0, sayIt: "Mateo finds the answer.", sayItEs: "Repite: «Mateo encuentra la respuesta.»", sayItCheck: { target: "Mateo finds the answer." } },
    { id: "q3", afterScene: "s8", questionEn: "How many clients are okay now?", questionEs: "¿Cuántos clientes están bien ahora?", options: [{ label: "Fifty", emoji: "5️⃣0️⃣" }, { label: "Five", emoji: "5️⃣" }, { label: "One", emoji: "1️⃣" }], answer: 0, sayIt: "Fifty clients are okay now.", sayItEs: "Repite: «Cincuenta clientes están bien ahora.»", sayItCheck: { target: "Fifty clients are okay now." } },
  ],
