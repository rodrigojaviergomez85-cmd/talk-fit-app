...
export const SHARKS_EP10_PARTNER_OR_RIVAL: StorybookEpisode = {
  ...
  "quizzes": [
    ...
    },
    {
      ...
      "options": [
        {
          "label": "Vale, Lucía is calling. Something went wrong in the first class.",
          "emoji": "⚡"
        },
        {
      ...
      "answer": 0,
      "sayIt": "Vale, Lucía is calling. Something went wrong in the first class.",
