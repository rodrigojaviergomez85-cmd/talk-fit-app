...
export const VALE_FAVORITE_FOOD: StorybookEpisode = {
  ...
  quizzes: [
    { id: "q1", afterScene: "s2", questionEn: "Is the office ready for lunch?", questionEs: "¿Está lista la oficina para almorzar?", options: [{ label: "Yes", emoji: "✅" }, { label: "No", emoji: "❌" }, { label: "Maybe", emoji: "🤔" }], answer: 0, sayIt: "The office is ready for lunch.", sayItEs: "Repite: «La oficina está lista para almorzar.»", sayItCheck: { target: "The office is ready for lunch." } },
    { id: "q2", afterScene: "s6", questionEn: "What is Vale's favorite food?", questionEs: "¿Cuál es la comida favorita de Vale?", options: [{ label: "Pupusas", emoji: "🫓" }, { label: "Pizza", emoji: "🍕" }, { label: "Tamales", emoji: "🫔" }], answer: 0, sayIt: "My favorite food is…", sayItEs: "Ahora tú: «Mi comida favorita es…»", sayItCheck: { target: "My favorite food is *", allowShortAnswer: true } },
    { id: "q3", afterScene: "s9", questionEn: "Why are pupusas special for Vale?", questionEs: "¿Por qué son especiales para Vale?", options: [{ label: "They remind her of family", emoji: "👨‍👩‍👧" }, { label: "They are purple", emoji: "💜" }, { label: "They are cold", emoji: "🥶" }], answer: 0, sayIt: "My favorite food is… because…", sayItEs: "Ahora di la tuya y una razón.", sayItCheck: { target: "My favorite food is *", allowShortAnswer: true } },
  ],
