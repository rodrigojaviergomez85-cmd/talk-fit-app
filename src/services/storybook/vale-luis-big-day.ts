...
export const VALE_LUIS_BIG_DAY: StorybookEpisode = {
  ...
  scenes: [
    ...
    { id: "s2", image: s2, imageAlt: "Vale anima a Luis en el desayuno.", text: '"You are ready, Luis. You can do it," says Vale.', es: "«Estás listo, Luis. Tú puedes», dice Vale.", speaker: "vale", words: [{ word: "can", es: "puedes" }, { word: "ready", es: "listo" }] },
  ...
  quizzes: [
    { id: "q1", afterScene: "s2", questionEn: "Who has an interview today?", questionEs: "¿Quién tiene una entrevista hoy?", options: [{ label: "Luis", emoji: "🧔🏻" }, { label: "Vale", emoji: "👧" }, { label: "Mateo", emoji: "👦" }], answer: 0, sayIt: "Luis has an interview today.", sayItEs: "Repite: «Luis tiene una entrevista hoy.»", sayItCheck: { target: "Luis has an interview today." } },
    { id: "q2", afterScene: "s5", questionEn: "Where is Luis from?", questionEs: "¿De dónde es Luis?", options: [{ label: "El Salvador", emoji: "🇸🇻" }, { label: "Canada", emoji: "🇨🇦" }, { label: "Honduras", emoji: "🇭🇳" }], answer: 0, sayIt: "He is from El Salvador.", sayItEs: "Repite: «Él es de El Salvador.»", sayItCheck: { target: "He is from El Salvador." } },
    { id: "q3", afterScene: "s7", questionEn: "How is the interview?", questionEs: "¿Cómo es la entrevista?", options: [{ label: "Very good", emoji: "😄" }, { label: "Very bad", emoji: "😞" }, { label: "Boring", emoji: "🥱" }], answer: 0, sayIt: "The interview is very good.", sayItEs: "Repite: «La entrevista es muy buena.»", sayItCheck: { target: "The interview is very good." } },
  ],
