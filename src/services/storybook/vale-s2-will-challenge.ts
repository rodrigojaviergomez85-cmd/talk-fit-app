...
import cover from "@/assets/storybook/vale-s2-ep15/cover.jpg";
import s1 from "@/assets/storybook/vale-s2-ep15/s1.jpg";
import s2 from "@/assets/storybook/vale-s2-ep15/s2.jpg";
import s3 from "@/assets/storybook/vale-s2-ep15/s3.jpg";
import s4 from "@/assets/storybook/vale-s2-ep15/s4.jpg";
import s5 from "@/assets/storybook/vale-s2-ep15/s5.jpg";
import s6 from "@/assets/storybook/vale-s2-ep15/s6.jpg";
import s7 from "@/assets/storybook/vale-s2-ep15/s7.jpg";
import s8 from "@/assets/storybook/vale-s2-ep15/s8.jpg";
import s9 from "@/assets/storybook/vale-s2-ep15/s9.jpg";
import s10 from "@/assets/storybook/vale-s2-ep15/s10.jpg";
  ...
  quizzes: [
    {
      ...
      answer: 0,
      sayIt: "I won’t use Spanish in my practice.",
      sayItEs: "Ejemplo: «I won’t use Spanish in my practice.»",
      sayItAskEn: "What language will you use in your practice?",
      sayItAskEs: "¿Qué idioma usarás en tu práctica?",
      sayItCheck: {
        target: "I won’t use *",
        altTargets: ["I will use *", "I’ll use *"],
      },
    },
    {
      id: "q2",
    ...
    },
    {
      ...
      answer: 0,
      sayIt: "I will win the English challenge.",
      sayItEs: "Ejemplo: «I will win the English challenge.»",
      sayItAskEn: "What challenge will you win this month?",
      sayItAskEs: "¿Qué reto ganarás este mes?",
      sayItCheck: {
        target: "I will win *",
        altTargets: ["I’ll win *"],
      },
