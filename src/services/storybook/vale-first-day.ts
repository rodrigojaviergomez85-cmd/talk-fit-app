  ...
  quizzes: [
    {
      ...
      answer: 0,
      sayIt: "My name is…",
      sayItEs: "Ahora di tu nombre: «Me llamo…» (puedes decir solo tu nombre)",
      sayItCheck: { target: "My name is *", allowShortAnswer: true },
    },
    {
      id: "q2",
      afterScene: "s7",
      ...
      answer: 0,
      sayIt: "My favorite food is…",
      sayItEs: "Ahora di la tuya: «Mi comida favorita es…» (puedes decir solo la comida)",
      sayItCheck: { target: "My favorite food is *", allowShortAnswer: true },
    },
    {
      id: "q3",
      afterScene: "s8",
      ...
      answer: 0,
      sayIt: "I am from…",
      sayItEs: "Ahora di tu país: «Soy de…» (puedes decir solo el lugar)",
      sayItCheck: { target: "I am from *", allowShortAnswer: true },
    },
  ],
  continuePrompt: {
