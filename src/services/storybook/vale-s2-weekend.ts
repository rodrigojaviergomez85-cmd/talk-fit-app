...
export const VALE_S2_WEEKEND: StorybookEpisode = {
  ...
  quizzes: [
    ...
    },
    {
      id: "q3",
      afterScene: "s9",
      questionEn: "Why is the young man at their table?",
      questionEs: "¿Por qué está el joven en su mesa?",
      options: [
      ...
      answer: 0,
      sayIt: "I’m going to join the team.",
      sayItEs: "Ahora contesta tú: «Voy a unirme al equipo.»",
      sayItCheck: {
        target: "I’m going to join *",
        altTargets: ["I’m going to join the team"],
      },
    },
  ],
  mindsetCard: {
