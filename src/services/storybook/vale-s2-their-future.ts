...
import cover from "@/assets/storybook/vale-s2-ep14/cover.jpg";
import s1 from "@/assets/storybook/vale-s2-ep14/s1.jpg";
import s2 from "@/assets/storybook/vale-s2-ep14/s2.jpg";
import s3 from "@/assets/storybook/vale-s2-ep14/s3.jpg";
import s4 from "@/assets/storybook/vale-s2-ep14/s4.jpg";
import s5 from "@/assets/storybook/vale-s2-ep14/s5.jpg";
import s6 from "@/assets/storybook/vale-s2-ep14/s6.jpg";
import s7 from "@/assets/storybook/vale-s2-ep14/s7.jpg";
import s8 from "@/assets/storybook/vale-s2-ep14/s8.jpg";
import s9 from "@/assets/storybook/vale-s2-ep14/s9.jpg";
import s10 from "@/assets/storybook/vale-s2-ep14/s10.jpg";
...
export const VALE_S2_THEIR_FUTURE: StorybookEpisode = {
  ...
  quizzes: [
    ...
    },
    {
      id: "q2",
      afterScene: "s6",
      questionEn: "Who will travel and work with international clients?",
      questionEs: "¿Quién viajará y trabajará con clientes internacionales?",
      options: [
        { label: "Luis", emoji: "🧑‍💼" },
        { label: "Kat", emoji: "👩" },
        { label: "Ana", emoji: "👩‍💼" },
      ...
      answer: 0,
      sayIt: "I will work with international clients.",
      sayItEs: "Ejemplo: «I will work with international clients.»",
      sayItAskEn: "Who will you work with in five years?",
      sayItAskEs: "¿Con quién trabajarás en cinco años?",
      sayItCheck: {
        target: "I will work with *",
        altTargets: ["I’ll work with *"],
      },
    },
    {
      id: "q3",
      ...
      answer: 0,
      sayIt: "I’ll open my own company.",
      sayItEs: "Ejemplo: «I’ll open my own company.»",
      sayItAskEn: "What will you open in the future?",
      sayItAskEs: "¿Qué abrirás en el futuro?",
      sayItCheck: {
        target: "I will open *",
        altTargets: ["I’ll open *"],
      },
    },
  ],
  mindsetCard: {
