...
export const VALE_S2_FINAL_FLUENCY: StorybookEpisode = {
  ...
  quizzes: [
    ...
    },
    {
      ...
      answer: 0,
      sayIt: "I will practice every night.",
      sayItEs: "Ejemplo: «I will practice every night.»",
      sayItAskEn: "When will you practice your English?",
      sayItAskEs: "¿Cuándo vas a practicar tu inglés?",
      sayItCheck: {
        target: "I will practice *",
        altTargets: ["I’ll practice *"],
      },
    },
    {
      id: "q3",
      ...
      answer: 0,
      sayIt: "I will be a bilingual supervisor.",
      sayItEs: "Ejemplo: «I will be a bilingual supervisor.»",
      sayItAskEn: "What will you be in the future?",
      sayItAskEs: "¿Qué serás en el futuro?",
      sayItCheck: {
        target: "I will be *",
        altTargets: ["I’ll be *"],
      },
