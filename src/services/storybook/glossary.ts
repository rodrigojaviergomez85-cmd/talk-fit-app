...
export const BASE_GLOSSARY: Record<string, string> = {
  ...
  'comfortable': 'cómodo',
  'compliment': 'cumplido',
  'crime': 'crimen / travesura',
  'deck': 'presentación / conjunto de diapositivas',
  'dramatic': 'dramático',
  'guide': 'guía',
  'hid': 'se escondió / ocultó',
  'joke': 'broma',
  ...
  'recommended': 'recomendó / recomendado',
  'replace': 'reemplazar',
  'she\'ll': 'ella va a / ella hará',
  'straight': 'directo / directamente',
  'suppose': 'supón / imaginar',
  'sweating': 'sudando',
  'tiny': 'pequeñito / mínimo',
  'upgrade': 'mejorar / subir de nivel',
  ...
  depends: "depende",
  entirely: "completamente / por completo",
  ...
  rumour: "rumor",
  allowed: "permitido / con derecho a",
  border: "frontera",
  closest: "más cercano / más cercana",
  reserve: "reserva / de reserva",
  verify: "verificar",
  rice: "arroz",
  sale: "venta",
  ...
  // Advanced 1 rewritten finale vocabulary
  'ironed': 'planchado',
  'wi-fi': 'wifi / internet inalámbrico',
  'stomach': 'estómago',
  'faint': 'desmayarse',
  'twelve-month': 'de doce meses',
  'total': 'total',
  'million': 'millón',
  'vibes': 'vibras / ambiente',
  'maturity': 'madurez',
  'attack': 'ataque',
  'aside': 'a un lado',
  'wore': 'usó / llevaba puesto',
  'emotional': 'emocional',
  'invisible': 'invisible',
  'financial': 'financiero / financiera',
  ...
  'zombie': 'zombi',
  'oxygen': 'oxígeno',
  'ten-million-dollar': 'de diez millones de dólares',
  'small-room': 'de salón pequeño',
  'soul': 'alma',
  'attacked': 'atacado / atacó',
  'disrespected': 'irrespetado',
  'pretends': 'finge',
  'furniture': 'mueble',
  'shiny': 'brillante',
  'cleaner': 'más limpio / más claro',
  'higher': 'más alto',
  'keller': 'Ms. Keller (personaje)',
  'heroically': 'heroicamente',
  'objective': 'objetivo',
  'debrief': 'reunión de cierre / resumen',
  'statistically': 'estadísticamente',
  'educated': 'educado / instruido',
  'damage': 'daño',
  ...
  'unicorn': 'unicornio',
  'earth': 'tierra',
  'emotional-support': 'de apoyo emocional',
  'denied': 'denegado / rechazado',
  'realistic': 'realista',
  'mildly': 'ligeramente',
  'spotlight': 'foco / atención',
  'dazzled': 'deslumbrado / deslumbrada',
  'provided': 'siempre que / con tal de que',
  'technician': 'técnico / técnica',
  'harmless': 'inofensivo',
  'blinking': 'parpadeando',
  'nickname': 'apodo',
  'swap': 'intercambiar',
  'overtime': 'horas extra',
  'apologetic': 'que se disculpa demasiado',
  'absorb': 'absorber',
  'devastating': 'devastador',
  'adjusted': 'ajustado / ajustó',
  'escalate': 'escalar / elevar',
  'trade-off': 'intercambio / sacrificio',
  'side-eyes': 'miradas de juicio',
  'stressed': 'estresado',
  'theory': 'teoría',
  'parkour': 'parkour',
  'blocked': 'bloqueado / bloqueó',
  'branding': 'marca / imagen de marca',
  'embarrassing': 'vergonzoso',
  'literally': 'literalmente',
  'assemblies': 'asambleas',
  'sentimental': 'sentimental',
  'targeted': 'señalado / aludido',
  'service recovery': 'recuperación de servicio',
  'jump scares': 'sustos repentinos',
  'toast': 'brindis',
  ...
  'cache': 'caché (memoria temporal)',
  'restart': 'reiniciar',
  'logo': 'logo',
  'dead': 'muerto; sin señal',
  'background': 'fondo',
  ...
  'glasses': 'lentes',
  'twenty-year-old': 'de veinte años',
  'clip': 'clip, video corto',
  'available': 'disponible',
  'plane': 'avión',
  'whichever': 'la que sea, cualquiera que',
  'forty-first': 'cuadragésimo primero (el número cuarenta y uno)',
  'follower': 'seguidor',
  ...
  'acted': 'actuó',
  'reaction': 'reacción',
  'one-to-one': 'uno a uno (reunión individual)',
  ...
  'billing': 'facturación',
  'seems': 'parece',
  'red-haired': 'pelirroja / pelirrojo',
  'camera': 'cámara',
  ...
  'rehearse': 'ensayar',
  "building's": 'del edificio',
  'slide': 'diapositiva',
  'cohort': 'cohorte, grupo (de una promoción)',
  'resolution': 'resolución',
  'suspended': 'suspendido',
  'pending': 'pendiente, en espera de',
  'downstairs': 'abajo (en el piso de abajo)',
  'suspension': 'suspensión',
  'frozen': 'congelado, paralizado',
  'stool': 'banco, taburete',
  'erase': 'borrar',
  'suspend': 'suspender',
  'what-if': 'un "qué pasaría si" (hipótesis)',
  'airport': 'aeropuerto',
  'stream': 'transmisión en vivo',
  'nephew': 'sobrino',
  'stranger': 'desconocido, extraño',
  'tip': 'punta (tip of the tongue: punta de la lengua)',
  'uncrossing': 'descruzando (los brazos)',
  ...
  'volume': 'volumen',
  "timer's": 'del cronómetro (timer is: el cronómetro está)',
  'mentor': 'mentor',
  'prayed': 'oró, había orado',
  'couch': 'sofá',
  'comé': 'comé (voseo: come)',
  'lifts': 'levanta',
  'dictionary': 'diccionario',
  'generous': 'generosa, generoso',
  'eighty': 'ochenta',
  'effective': 'efectivo, a partir de',
  'resources': 'recursos',
  'leaning': 'apoyado, inclinado',
  'secret': 'secreto',
  'retakes': 'reintentos (de un examen)',
  'wallet': 'billetera',
  'dark': 'oscuridad, oscuro',
  'comma': 'coma',
  'aisle': 'pasillo',
};
...
export const PROPER_NOUNS: Record<string, string> = {
  ...
  chicago: "Chicago (ciudad de Estados Unidos)",
  cruz: "Cruz (apellido de Renata)",
  rubén: "Rubén (nombre de un papá)",
  abril: "Abril (la hermana de Nico)",
  tomás: "Tomás (agente en Monterrey)",
  los: "Los (parte de Los Ángeles)",
  angeles: "Ángeles (parte de Los Ángeles)",
  february: "febrero",
...
export const CONTRACTIONS: Record<string, string> = {
  ...
  "he'd": "él (condicional: he would)",
  "she'd": "ella (condicional: she would)",
  rewrote: "reescribió",
  unprepared: "sin preparación",
  squeaks: "rechina",
  corridor: "pasillo",
  row: "fila",
  slips: "se atrasa, se resbala",
  apologise: "disculparse",
  july: "julio",
  rise: "subir, aumentar",
  discover: "descubrir",
  private: "privado, en privado",
  "i've": "yo he (ya hice)",
