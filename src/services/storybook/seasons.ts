...
export const STORYBOOK_SEASONS: Season[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { day: 17, episodeId: "advanced1-ep17-show-me-dont-tell-me", teaser: { en: "Show me, don't tell me", es: "Demuéstramelo, no me lo cuentes" } },
      { day: 18, episodeId: "advanced1-ep18-the-question-nobody-prepares-for", teaser: { en: "The question nobody prepares for", es: "La pregunta para la que nadie se prepara" } },
      { day: 19, episodeId: "advanced1-ep19-now-you-ask", teaser: { en: "Now you ask", es: "Ahora preguntas tú" } },
