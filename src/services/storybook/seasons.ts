...
export const STORYBOOK_SEASONS: Season[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { day: 17, episodeId: "advanced1-ep17-show-me-dont-tell-me", teaser: { en: "Show me, don't tell me", es: "Muéstramelo, no me lo cuentes" } },
  ...
  },
  {
    ...
    slots: [
      { day: 1, episodeId: "advanced2-ep1-headset-on", teaser: { en: "Headset on", es: "Diadema puesta" } },
      { day: 2, episodeId: "advanced2-ep2-three-changes-of-mind", teaser: { en: "Three changes of mind", es: "Tres cambios de opinión" } },
      { day: 3, episodeId: "advanced2-ep3-ninety-days", teaser: { en: "Ninety days", es: "Noventa días" } },
      { day: 4, episodeId: "advanced2-ep4-the-line-item", teaser: { en: "The line item", es: "La línea de la factura" } },
      { day: 5, episodeId: "advanced2-ep5-the-remittance", teaser: { en: "The remittance", es: "La remesa" } },
      { day: 6, episodeId: "advanced2-ep6-keller-at-the-door", teaser: { en: "Keller at the door", es: "Keller en la puerta" } },
      { day: 7, episodeId: "advanced2-ep7-value-first", teaser: { en: "Value first", es: "Primero el valor" } },
      { day: 8, episodeId: "advanced2-ep8-crown-or-here", teaser: { en: "Crown or here", es: "Crown o aquí" } },
      { day: 9, episodeId: "advanced2-ep9-too-expensive", teaser: { en: "Too expensive", es: "Es muy caro" } },
      { day: 10, episodeId: "advanced2-ep10-dont-make-it-weird", teaser: { en: "Don't make it weird", es: "No lo hagas raro" } },
      { day: 11, episodeId: "advanced2-ep11-bogota-is-waiting", teaser: { en: "Bogotá is waiting", es: "Bogotá está esperando" } },
      { day: 12, episodeId: "advanced2-ep12-one-step-at-a-time", teaser: { en: "One step at a time", es: "Un paso a la vez" } },
      { day: 13, episodeId: "advanced2-ep13-no-phones-on-the-floor", teaser: { en: "No phones on the floor", es: "Sin celulares en el piso" } },
      { day: 14, episodeId: "advanced2-ep14-the-lobby", teaser: { en: "The lobby", es: "El lobby" } },
      { day: 15, episodeId: "advanced2-ep15-not-this-thursday", teaser: { en: "Not this Thursday", es: "Este jueves no" } },
      { day: 16, episodeId: "advanced2-ep16-nico-hung-up", teaser: { en: "Nico hung up", es: "Nico colgó" } },
      { day: 17, episodeId: "advanced2-ep17-one-to-one", teaser: { en: "One to one", es: "Uno a uno" } },
      { day: 18, episodeId: "advanced2-ep18-mia-teaches", teaser: { en: "Mía teaches", es: "Mía enseña" } },
      { day: 19, episodeId: "advanced2-ep19-the-audit", teaser: { en: "The audit", es: "La auditoría" } },
      { day: 20, episodeId: "advanced2-ep20-day-ninety", teaser: { en: "Day ninety", es: "Día noventa" } },
    ],
  },
  {
    moduleId: "advanced-3",
    ...
    slots: [
      { day: 1, episodeId: "advanced3-ep1-two-million", teaser: { en: "Two million", es: "Dos millones" } },
      { day: 2, episodeId: "advanced3-ep2-the-comments", teaser: { en: "The comments", es: "Los comentarios" } },
      { day: 3, episodeId: "advanced3-ep3-miami-six-months", teaser: { en: "Miami, six months", es: "Miami, seis meses" } },
      { day: 4, episodeId: "advanced3-ep4-mias-night", teaser: { en: "Mía's night", es: "La noche de Mía" } },
      { day: 5, episodeId: "advanced3-ep5-the-livestream", teaser: { en: "The livestream", es: "El en vivo" } },
      { day: 6, episodeId: "advanced3-ep6-the-accent-question", teaser: { en: "The accent question", es: "La pregunta del acento" } },
      { day: 7, episodeId: "advanced3-ep7-app-or-room", teaser: { en: "App or room", es: "La app o el salón" } },
      { day: 8, episodeId: "advanced3-ep8-nico-wants-to-quit", teaser: { en: "Nico wants to quit", es: "Nico quiere renunciar" } },
      { day: 9, episodeId: "advanced3-ep9-miami-or-here", teaser: { en: "Miami or here", es: "Miami o aquí" } },
      { day: 10, episodeId: "advanced3-ep10-a-meme-not-a-director", teaser: { en: "A meme, not a director", es: "Un meme, no un director" } },
      { day: 11, episodeId: "advanced3-ep11-the-small-room", teaser: { en: "The small room", es: "El salón pequeño" } },
      { day: 12, episodeId: "advanced3-ep12-bogota-blackout", teaser: { en: "Bogotá, blackout", es: "Bogotá, apagón" } },
      { day: 13, episodeId: "advanced3-ep13-teach-the-teacher", teaser: { en: "Teach the teacher", es: "Enseñarle al que enseña" } },
      { day: 14, episodeId: "advanced3-ep14-if-you-had-taken-crown", teaser: { en: "If you had taken Crown", es: "Si hubieras aceptado Crown" } },
      { day: 15, episodeId: "advanced3-ep15-why-people-freeze", teaser: { en: "Why people freeze", es: "Por qué la gente se congela" } },
      { day: 16, episodeId: "advanced3-ep16-the-knock", teaser: { en: "The knock", es: "El toque en la puerta" } },
      { day: 17, episodeId: "advanced3-ep17-three-years", teaser: { en: "Three years", es: "Tres años" } },
      { day: 18, episodeId: "advanced3-ep18-monterrey", teaser: { en: "Monterrey", es: "Monterrey" } },
      { day: 19, episodeId: "advanced3-ep19-what-i-didnt-say", teaser: { en: "What I didn't say", es: "Lo que no dije" } },
      { day: 20, episodeId: "advanced3-ep20-headset-on-again", teaser: { en: "Headset on, again", es: "La diadema, otra vez" } },
    ],
  },
];
