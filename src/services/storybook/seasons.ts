...
export const STORYBOOK_SEASONS: Season[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { day: 5, episodeId: null, teaser: { en: "What would you do?", es: "¿Qué harías tú?" } },
      { day: 6, episodeId: null, teaser: { en: "Then & now", es: "Antes y ahora" } },
      { day: 7, episodeId: null, teaser: { en: "Have you ever?", es: "¿Alguna vez?" } },
      { day: 8, episodeId: null, teaser: { en: "Weeks of effort", es: "Semanas de esfuerzo" } },
      { day: 9, episodeId: null, teaser: { en: "The complaint", es: "El reclamo" } },
      { day: 10, episodeId: null, teaser: { en: "A new problem", es: "Un problema nuevo" } },
      { day: 11, episodeId: null, teaser: { en: "I used to work there", es: "Yo trabajaba ahí" } },
      { day: 12, episodeId: null, teaser: { en: "Which schedule is better?", es: "¿Cuál horario es mejor?" } },
      { day: 13, episodeId: null, teaser: { en: "Online or in person", es: "En línea o presencial" } },
      { day: 14, episodeId: null, teaser: { en: "The best plan", es: "El mejor plan" } },
      { day: 15, episodeId: null, teaser: { en: "A great teacher", es: "Una gran maestra" } },
      { day: 16, episodeId: null, teaser: { en: "Another country", es: "Otro país" } },
      { day: 17, episodeId: null, teaser: { en: "So far, so good", es: "Hasta ahora, bien" } },
      { day: 18, episodeId: null, teaser: { en: "Dani's long road", es: "El largo camino de Dani" } },
      { day: 19, episodeId: null, teaser: { en: "The angry director", es: "El director molesto" } },
      { day: 20, episodeId: null, teaser: { en: "The contract", es: "El contrato" } },
    ],
  },
];
