...
import cover from "@/assets/storybook/vale-s2-ep12/cover.jpg";
import s1 from "@/assets/storybook/vale-s2-ep12/s1.jpg";
import s2 from "@/assets/storybook/vale-s2-ep12/s2.jpg";
import s3 from "@/assets/storybook/vale-s2-ep12/s3.jpg";
import s4 from "@/assets/storybook/vale-s2-ep12/s4.jpg";
import s5 from "@/assets/storybook/vale-s2-ep12/s5.jpg";
import s6 from "@/assets/storybook/vale-s2-ep12/s6.jpg";
import s7 from "@/assets/storybook/vale-s2-ep12/s7.jpg";
import s8 from "@/assets/storybook/vale-s2-ep12/s8.jpg";
import s9 from "@/assets/storybook/vale-s2-ep12/s9.jpg";
import s10 from "@/assets/storybook/vale-s2-ep12/s10.jpg";
  ...
  quizzes: [
    {
      ...
      answer: 0,
      sayIt: "I’ll help my brother with his English.",
      sayItEs: "Ejemplo: «I’ll help my brother with his English.»",
      sayItAskEn: "Who will you help this month?",
      sayItAskEs: "¿A quién ayudarás este mes?",
      sayItCheck: {
        target: "I will help *",
        altTargets: ["I’ll help *"],
      },
    },
    {
      id: "q2",
      ...
      answer: 0,
      sayIt: "I’ll practice English every week.",
      sayItEs: "Ejemplo: «I’ll practice English every week.»",
      sayItAskEn: "What will you do every week? Promise it.",
      sayItAskEs: "¿Qué harás cada semana? Promételo.",
      sayItCheck: {
        target: "I will * every week",
        altTargets: ["I’ll * every week"],
      },
    },
    {
      id: "q3",
