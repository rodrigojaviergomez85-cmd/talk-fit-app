...
import cover from "@/assets/storybook/vale-s2-ep13/cover.jpg";
import s1 from "@/assets/storybook/vale-s2-ep13/s1.jpg";
import s2 from "@/assets/storybook/vale-s2-ep13/s2.jpg";
import s3 from "@/assets/storybook/vale-s2-ep13/s3.jpg";
import s4 from "@/assets/storybook/vale-s2-ep13/s4.jpg";
import s5 from "@/assets/storybook/vale-s2-ep13/s5.jpg";
import s6 from "@/assets/storybook/vale-s2-ep13/s6.jpg";
import s7 from "@/assets/storybook/vale-s2-ep13/s7.jpg";
import s8 from "@/assets/storybook/vale-s2-ep13/s8.jpg";
import s9 from "@/assets/storybook/vale-s2-ep13/s9.jpg";
import s10 from "@/assets/storybook/vale-s2-ep13/s10.jpg";
...
export const VALE_S2_PREDICTION: StorybookEpisode = {
  ...
  quizzes: [
    ...
    },
    {
      ...
      answer: 0,
      sayIt: "I think I will speak English this year.",
      sayItEs: "Ejemplo: «I think I will speak English this year.»",
      sayItAskEn: "Do you think you will speak English this year?",
      sayItAskEs: "¿Crees que hablarás inglés este año?",
      sayItCheck: {
        target: "I think I will *",
      },
    },
    {
      id: "q3",
      ...
      answer: 0,
      sayIt: "I will practice with two people.",
      sayItEs: "Ejemplo: «I will practice with two people.»",
      sayItAskEn: "How many people will you practice with this week?",
      sayItAskEs: "¿Con cuántas personas practicarás esta semana?",
      sayItCheck: {
        target: "I will practice with *",
        altTargets: ["I’ll practice with *"],
      },
    },
  ],
  mindsetCard: {
