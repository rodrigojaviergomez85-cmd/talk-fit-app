...
import cover from "@/assets/storybook/vale-s2-ep16/cover.jpg";
import s1 from "@/assets/storybook/vale-s2-ep16/s1.jpg";
import s2 from "@/assets/storybook/vale-s2-ep16/s2.jpg";
import s3 from "@/assets/storybook/vale-s2-ep16/s3.jpg";
import s4 from "@/assets/storybook/vale-s2-ep16/s4.jpg";
import s5 from "@/assets/storybook/vale-s2-ep16/s5.jpg";
import s6 from "@/assets/storybook/vale-s2-ep16/s6.jpg";
import s7 from "@/assets/storybook/vale-s2-ep16/s7.jpg";
import s8 from "@/assets/storybook/vale-s2-ep16/s8.jpg";
import s9 from "@/assets/storybook/vale-s2-ep16/s9.jpg";
import s10 from "@/assets/storybook/vale-s2-ep16/s10.jpg";
...
export const VALE_S2_PLAN_VS_DECISION: StorybookEpisode = {
  ...
  quizzes: [
    ...
    },
    {
      ...
      answer: 0,
      sayIt: "At two, I’m going to study English.",
      sayItEs: "Ejemplo: «At two, I’m going to study English.»",
      sayItAskEn: "What are you going to do at two today?",
      sayItAskEs: "¿Qué vas a hacer a las dos hoy?",
      sayItCheck: {
        target: "I’m going to *",
      },
    },
    {
      ...
      answer: 0,
      sayIt: "We are going to practice questions.",
      sayItEs: "Ejemplo: «We are going to practice questions.»",
      sayItAskEn: "What are you and your friend going to practice tomorrow?",
      sayItAskEs: "¿Qué van a practicar tú y tu amigo mañana?",
      sayItCheck: {
        target: "We are going to practice *",
        altTargets: ["We’re going to practice *"],
      },
    },
  ],
  mindsetCard: {
