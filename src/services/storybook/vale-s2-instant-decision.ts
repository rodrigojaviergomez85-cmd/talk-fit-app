...
import cover from "@/assets/storybook/vale-s2-ep11/cover.jpg";
import s1 from "@/assets/storybook/vale-s2-ep11/s1.jpg";
import s2 from "@/assets/storybook/vale-s2-ep11/s2.jpg";
import s3 from "@/assets/storybook/vale-s2-ep11/s3.jpg";
import s4 from "@/assets/storybook/vale-s2-ep11/s4.jpg";
import s5 from "@/assets/storybook/vale-s2-ep11/s5.jpg";
import s6 from "@/assets/storybook/vale-s2-ep11/s6.jpg";
import s7 from "@/assets/storybook/vale-s2-ep11/s7.jpg";
import s8 from "@/assets/storybook/vale-s2-ep11/s8.jpg";
import s9 from "@/assets/storybook/vale-s2-ep11/s9.jpg";
import s10 from "@/assets/storybook/vale-s2-ep11/s10.jpg";
  ...
  quizzes: [
    {
      ...
      answer: 0,
      sayIt: "I’ll study English right now.",
      sayItEs: "Ejemplo: «I’ll study English right now.»",
      sayItAskEn: "What will you do right now to practice?",
      sayItAskEs: "¿Qué harás ahora mismo para practicar?",
      sayItCheck: {
        target: "I will * right now",
        altTargets: ["I’ll * right now"],
      },
    },
    {
      id: "q2",
      ...
      answer: 0,
      sayIt: "I’ll send a message to my friend.",
      sayItEs: "Ejemplo: «I’ll send a message to my friend.»",
      sayItAskEn: "Who will you send a message to today?",
      sayItAskEs: "¿A quién le enviarás un mensaje hoy?",
      sayItCheck: {
        target: "I will send *",
        altTargets: ["I’ll send *"],
      },
    },
    {
      id: "q3",
