  ...
  quizzes: [
    {
      id: "q1",
      afterScene: "s3",
      questionEn: "What is the real problem on Morgan's team?",
      questionEs: "¿Cuál es el problema real del equipo de Morgan?",
      options: [
        { label: "They freeze speaking under pressure", emoji: "😰" },
        { label: "They don't have computers", emoji: "💻" },
        { label: "They work at night", emoji: "🌙" },
      ],
      answer: 0,
      sayIt: "They freeze when they speak under pressure.",
      sayItEs: "Ejemplo: «They freeze when they speak under pressure.»",
      sayItAskEn: "When do you freeze in English? Tell me one moment.",
      sayItAskEs: "¿Cuándo te congelas en inglés? Cuéntame un momento.",
      sayItCheck: {
        target: "I freeze when *",
        altTargets: ["I get nervous when *", "I freeze *"],
      },
    },
    {
      id: "q2",
      afterScene: "s6",
      questionEn: "Which option does Vale recommend, and why?",
      questionEs: "¿Qué opción recomienda Vale y por qué?",
      options: [
        { label: "Option B, because they need to speak", emoji: "🗣️" },
        { label: "Option A, because it is cheaper", emoji: "💸" },
        { label: "No option, she says no", emoji: "🚫" },
      ],
      answer: 0,
      sayIt: "I recommend option B, because they need to speak.",
      sayItEs: "Ejemplo: «I recommend option B, because they need to speak.»",
      sayItAskEn: "Recommend something to a friend. What do you recommend, and why?",
      sayItAskEs: "Recomiéndale algo a un amigo. ¿Qué recomiendas y por qué?",
      sayItCheck: {
        target: "I recommend *",
        altTargets: ["I would recommend *", "My recommendation is *"],
      },
    },
    {
      id: "q3",
      afterScene: "s9",
      questionEn: "What does Morgan need before the contract?",
      questionEs: "¿Qué necesita Morgan antes del contrato?",
      options: [
        { label: "A proposal by Friday", emoji: "📄" },
        { label: "A free class today", emoji: "🎁" },
        { label: "Thirty new laptops", emoji: "💼" },
      ],
      answer: 0,
      sayIt: "She needs a proposal by Friday.",
      sayItEs: "Ejemplo: «She needs a proposal by Friday.»",
      sayItAskEn: "Someone says your price is expensive. How do you answer?",
      sayItAskEs: "Alguien dice que tu precio es caro. ¿Cómo respondes?",
      sayItCheck: {
        target: "I understand *",
        altTargets: ["I understand, but *", "Let me show you *", "It is expensive, but *"],
      },
    },
  ],
  mindsetCard: {
