...
import { EAGLES_WEEK_1_WEEKS, card, l, makeDay, p } from "./course-builders";

// Builders live in course-builders.ts; re-exported here for compatibility.
export { EAGLES_WEEK_1_WEEKS, card, l, makeDay, p } from "./course-builders";
export type { EaglesDayInput, WeekMeta } from "./course-builders";
