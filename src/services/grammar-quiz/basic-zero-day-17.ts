...
export const BASIC_ZERO_DAY_17: GrammarQuiz = {
  ...
  items: [
    ...
    mc("bzg17-4", "Is his favorite fruit mango? · Yes, it ___.", "¿Su fruta favorita es el mango? · Sí.", ["is", "are", "does"], 0, {
      en: "Yes, it is.",
      es: "fruit = it → Yes, it is.",
    }),
    mistake("bzg17-5", "This is my friend Camila. His favorite fruit is pear.", "His", "Her", {
      en: "Camila → her.",
      es: "Camila es mujer → Her favorite fruit.",
    }, DETECTIVE),
    mistake("bzg17-6", "What are her favorite fruit?", "are", "is", {
      en: "favorite fruit is.",
      es: "favorite fruit → is.",
    }, DETECTIVE),
    rearrange(
      "bzg17-7",
    ...
    // ── Transferencia ──────────────────────────────────────────────────────
    mc("bzg17-9", "My ___ favorite fruit is lime. (mother)", "La fruta favorita de mi mamá es el limón.", ["mother's", "mother", "mothers"], 0, {
      en: "my mother's favorite fruit: 's.",
      es: "my mother's favorite fruit: de mi mamá, con 's.",
    }),
    ...
    mc("bzg17-11", "Do you like oranges? · Yes, I ___.", "¿Te gustan las naranjas? · Sí.", ["do", "like", "am"], 0, {
      en: "Yes, I do.",
      es: "Yes, I do. La respuesta corta a Do you ...? es do.",
    }),
    ...
    rearrange(
      ...
      ["oranges", "I", "like"],
      ["I", "like", "oranges"],
      { en: "I + like + plural noun.", es: "I + like + sustantivo en plural, sin the." },
      CHISME,
    ),
    rearrange(
      "bzg17-14",
      ["is", "mango", "My brother's favorite fruit"],
      ["My brother's favorite fruit", "is", "mango"],
      { en: "My brother's favorite fruit + is + fruit.", es: "My brother's favorite fruit + is + fruta." },
      CHISME,
    ),

    // ── Repaso ─────────────────────────────────────────────────────────────
    mc("bzg17-15", "Camila is ___ nurse. She is 29 and she ___ in San Pedro Sula.", "Camila es enfermera. Tiene 29 y vive en San Pedro Sula.", ["a / lives", "an / lives", "a / live"], 0, {
      en: "a nurse, she lives.",
      es: "a nurse (consonante), she lives (con -s).",
    }),
    mc("bzg17-16", "___ is my friend Camila and ___ are her sisters.", "Esta es mi amiga Camila y esas son sus hermanas.", ["This / those", "These / that", "This / this"], 0, {
      en: "this (one, near), those (many, far).",
      es: "this: una, cerca. those: varias, lejos.",
    }),
    mistake("bzg17-17", "Camila have 29 years old.", "have", "is", {
      en: "She is 29.",
      es: "Camila is 29 years old.",
    }, DETECTIVE),
    mistake("bzg17-18", "Her eyes is brown.", "is", "are", {
      en: "eyes → are.",
