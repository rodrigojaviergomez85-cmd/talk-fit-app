...
const STRINGS = {
  es: {
    ...
    installedNextDesktop: "Busca Fluency App en tu pantalla de inicio o menú de aplicaciones para abrirla.",
  ...
  en: {
    ...
    installedNextDesktop: "Find Fluency App on your home screen or app drawer to open it.",
