...
const DICT = {
  ...
  // Basic Zero · Week 1 · Step 1 (listening screen)
  "listen.day": ["Día {day}", "Day {day}"],
  "listen.step": ["Paso 1 de 5 · Escucha", "Step 1 of 5 · Listen"],
  "listen.stepsAria": ["Paso 1 de 5", "Step 1 of 5"],
  "listen.back": ["Volver", "Back"],
  "listen.more": ["Más opciones", "More options"],
  "listen.nextStep": ["Siguiente paso", "Next step"],
  "listen.exit": ["Salir", "Exit"],
  "listen.title": ["Tu día, en inglés.", "Your day, in English."],
  "listen.lead": ["Primero escucha. Después, tú.", "Listen first. Then it’s your turn."],
  "listen.hint": ["Escucha el modelo. Todavía no hables.", "Listen to the example. Don’t speak yet."],
  "listen.challenge": ["Tu reto", "Your challenge"],
  "listen.translate": ["Traducir", "Translate"],
  "listen.hideTranslation": ["Ocultar traducción", "Hide translation"],
  "listen.hearQuestion": ["OÍR PREGUNTA", "LISTEN TO THE QUESTION"],
  "listen.hearExample": ["ESCUCHAR EJEMPLO", "LISTEN TO THE EXAMPLE"],
  "listen.resumeAudio": ["REANUDAR AUDIO", "RESUME AUDIO"],
  "listen.resumeAudioAria": ["Reanudar audio", "Resume audio"],
  "listen.speakerName": ["Escucha a {name}", "Listen to {name}"],
  "listen.speakerFallback": ["Escucha el ejemplo", "Listen to the example"],
  "listen.exampleAnswer": ["Una respuesta de ejemplo", "An example answer"],
  "listen.showText": ["Ver texto", "Show text"],
  "listen.hideText": ["Ocultar texto", "Hide text"],
  "listen.textAria": ["Texto del ejemplo", "Example text"],
  "listen.continue": ["Continuar", "Continue"],
  "listen.skip": ["Saltar por ahora", "Skip for now"],
  "listen.skipHint": [
    "Escucha el ejemplo o salta por ahora.",
    "Listen to the example or skip for now.",
  ],
  "listen.progressAria": ["Progreso del ejemplo", "Example progress"],
  "listen.announcePlaying": ["Reproduciendo ejemplo", "Playing example"],
  "listen.announcePaused": ["Ejemplo en pausa", "Example paused"],
  "listen.announceStopped": ["Ejemplo detenido", "Example stopped"],
  "listen.announceEnded": ["Ejemplo terminado", "Example finished"],
} as const;
