...
BEGIN
  ...
  VALUES (
    _uid, _episode_id, _season, _episode_number,
...
REVOKE ALL ON FUNCTION public.record_story_view(text, smallint, smallint, integer, boolean) FROM public;
GRANT EXECUTE ON FUNCTION public.record_story_view(text, smallint, smallint, integer, boolean) TO authenticated;