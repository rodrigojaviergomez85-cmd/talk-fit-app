...
- **Week 2 — EVERYDAY LIFE (Present + Past, future review)**: My Routine (I) · Someone Else's Routine (she, consistent) — routines recast around new verbs (run, cook, exercise, drive, practice, clean) rather than work/study repeats · What Was Happening? (one large office scene: Maria / Carlos / coworkers / manager, present vs past progressive) · Listen & Respond (Ana's day audio → 5 spoken comprehension questions, written with the fresh verbs) · Every Day, Yesterday & Tomorrow challenge.
...
- **Week 4 — REAL CONVERSATION (transfer)**: My Life: Past, Present & Future · Someone Else's Story (Sofia: drove a delivery truck → designs websites from home → she's going to learn marketing → I think she'll start her own business) · Ask Me Anything (Sunday questions across tenses) · Real Conversation Challenge (meeting a new coworker, 5 conversational questions) · Mixed Tense Fluency Challenge.
