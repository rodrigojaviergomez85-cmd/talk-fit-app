...
- **Week 1 — YESTERDAY & TOMORROW (Past + Future)**: Yesterday, Today & Tomorrow · My Future Plans (going to + will review) · What I Did Yesterday (regular -ed verbs, learned by hear/copy/shadow; the /t/ /d/ /ɪd/ note lives only in the collapsible help) · An Interesting Day (irregular verbs: went, met, ate, saw, bought, came, had) · Last Weekend & Next Weekend challenge.
